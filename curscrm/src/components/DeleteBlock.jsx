          ...
          (
            <div className="delete-icon" onClick={deleteTicket} id={ticket.owner}>
              <svg width="31" height="31" viewBox="0 0 31 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="15.5" cy="15.5" r="11.5" stroke="#FF3B51" strokeWidth="2" />
                <path d="M11 20.1459L19.625 11.5209" stroke="#FF3B51" strokeWidth="2" />
                <path d="M20 20.1459L11.375 11.5209" stroke="#FF3B51" strokeWidth="2" />
              </svg>
