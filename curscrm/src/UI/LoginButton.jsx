  ...
  return (
    <div className="icons" onClick={() => loginWithRedirect()}>
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M16 12L9 16" stroke="#CCD2E3" strokeWidth="2" strokeLinecap="round" />
        <path d="M16 12L2 12" stroke="#CCD2E3" strokeWidth="2" strokeLinecap="round" />
        ...
        <path d="M16 12L9 8" stroke="#CCD2E3" strokeWidth="2" strokeLinecap="round" />
      </svg>
    </div>
  );
};
